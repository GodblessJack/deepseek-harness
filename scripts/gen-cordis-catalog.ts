...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CanvasAttachmentStream: 'canvas download contract is owned by packages/host/canvas/src/types.ts',
  CanvasBodyStream: 'canvas download contract is owned by packages/host/canvas/src/types.ts',
  CanvasDemoRequest: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasDemoResult: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasGetRequest: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasGetResult: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasSelectRequest: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasSelectResult: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasState: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasStateRequest: 'canvas Remote wire contract is owned by packages/host/canvas/src/types.ts',
  CanvasArtifactAttachment: 'canvas artifact attachment record is owned by packages/host/canvas/src/index.ts',
  CanvasToolArgs: 'canvas tool argument vocabulary is owned by packages/host/canvas/src/index.ts',
  SnapshotMutationResult: 'canvas mutation result is owned by packages/host/canvas/src/index.ts',
