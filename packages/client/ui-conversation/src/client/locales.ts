...
export const zh = {
  ...
  'file.unsupportedType': '仅支持 PDF 文件',
  'file.tooMany': '一条消息最多 {count} 个 PDF',
  'file.fileTooLarge': '单个 PDF 不能超过 {size}',
  'file.uploadFailed': 'PDF 上传失败：{reason}',
  'file.pending': '待发送文件',
  ...
  'command.filesUnsupported': '/{command} 不接受 PDF 附件，请先移除',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
...
export const en = {
  ...
  'input.attach': 'Upload images or PDF',
  ...
  'file.unsupportedType': 'Only PDF files are supported',
  'file.tooMany': 'A message can include up to {count} PDFs',
  'file.fileTooLarge': 'Each PDF must be smaller than {size}',
  'file.uploadFailed': 'PDF upload failed: {reason}',
  ...
  'command.filesUnsupported': '/{command} does not accept PDF attachments; remove them first',
